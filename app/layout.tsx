...
export const metadata: Metadata = {
  title: '3D Me - Design with AI, Print on Demand',
  description: 'Effortlessly design 3D models using AI prompts, and let us handle the professional 3D printing and shipping. No printer maintenance required.',
  generator: 'v0.app',
  icons: {
    icon: [
      {
...
export default function RootLayout({
  ...
  var TOKEN="b8ff1440-809b-4913-81c7-159a7b6cd0fa6b6a62f6970c188f3b5ba55aa62179e5";
